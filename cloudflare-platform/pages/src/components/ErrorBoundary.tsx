        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-[#0a1628] p-4">
          <div className="max-w-md w-full bg-white dark:bg-[#0f1d32] rounded-2xl border border-slate-200 dark:border-white/[0.06] p-8 text-center">
            ...
            <div className="flex gap-3 justify-center">
              <button onClick={() => window.location.reload()} className="px-6 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold">Refresh Page</button>
              <a href="mailto:support@et.vantax.co.za?subject=Bug Report" className="px-6 py-2.5 rounded-xl bg-slate-100 dark:bg-white/[0.06] hover:bg-slate-200 dark:hover:bg-white/[0.1] text-slate-700 dark:text-slate-300 text-sm font-semibold">Report Issue</a>
            </div>
          </div>
        </div>
      );
