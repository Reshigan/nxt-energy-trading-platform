...
export const ROLE_CONFIGS: Record<PlatformRole, RoleConfig> = {
  generator: {
    ...
    accentHex: '#16A34A',
        allowedPaths: ['/', '/trading', '/carbon', '/contracts', '/analytics', '/markets', '/portfolio', '/metering', '/metering-analytics', '/ipp', '/settlement', '/compliance', '/reports', '/notifications', '/settings', '/demand', '/invoices', '/smart-rules', '/vault', '/trade-journal', '/carbon-deep', '/ipp-deep', '/reporting-engine', '/support', '/pipeline', '/calendar', '/vpp', '/ppa-valuation', '/esg', '/scheduling'],
        kpis: [
  ...
  trader: {
    ...
    accentHex: '#4F46E5',
    allowedPaths: ['/', '/trading', '/carbon', '/contracts', '/analytics', '/markets', '/portfolio', '/metering-analytics', '/risk', '/p2p', '/marketplace', '/settlement', '/reports', '/notifications', '/settings', '/smart-rules', '/invoices', '/vault', '/trade-journal', '/carbon-deep', '/reporting-engine', '/support', '/forward-curves', '/deal-room', '/scenarios', '/scheduling'],
    kpis: [
  ...
  offtaker: {
    ...
    accentHex: '#7C3AED',
    allowedPaths: ['/', '/carbon', '/contracts', '/analytics', '/markets', '/portfolio', '/metering-analytics', '/marketplace', '/p2p', '/settlement', '/compliance', '/reports', '/notifications', '/settings', '/demand', '/offtaker-cost', '/invoices', '/disputes', '/vault', '/trade-journal', '/offtaker-deep', '/reporting-engine', '/support', '/procurement', '/ppa-valuation', '/scenarios', '/pipeline', '/calendar', '/esg'],
    kpis: [
  ...
  ipp_developer: {
    ...
    accentHex: '#D97706',
        allowedPaths: ['/', '/contracts', '/analytics', '/ipp', '/metering', '/metering-analytics', '/settlement', '/compliance', '/reports', '/notifications', '/settings', '/demand', '/invoices', '/vault', '/ipp-deep', '/reporting-engine', '/support', '/pipeline'],
        kpis: [
  ...
  regulator: {
    ...
    accentBg: 'bg-red-500',
    accentHex: '#DC2626',
    allowedPaths: ['/', '/analytics', '/compliance', '/admin', '/reports', '/notifications', '/settings', '/metering', '/audit-trail', '/surveillance', '/surveillance-enhanced', '/reporting-engine', '/support', '/esg', '/metering-analytics'],
    kpis: [
  ...
  admin: {
    ...
    accentHex: '#525252',
    allowedPaths: ['/', '/trading', '/carbon', '/contracts', '/analytics', '/markets', '/portfolio', '/risk', '/metering', '/metering-analytics', '/p2p', '/ipp', '/marketplace', '/settlement', '/compliance', '/reports', '/developer', '/notifications', '/admin', '/settings', '/demand', '/offtaker-cost', '/disputes', '/invoices', '/smart-rules', '/audit-trail', '/system-health', '/tenant-admin', '/vault', '/lender', '/surveillance', '/surveillance-enhanced', '/trade-journal', '/carbon-deep', '/ipp-deep', '/offtaker-deep', '/reporting-engine', '/staff', '/support-dashboard', '/support', '/platform-config', '/aml-dashboard', '/payments', '/dashboard', '/modules', '/forward-curves', '/ppa-valuation', '/deal-room', '/vpp', '/scenarios', '/esg', '/pipeline', '/calendar', '/network', '/grid-dashboard', '/fund-dashboard', '/procurement', '/scheduling', '/data-retention', '/changelog'],
    kpis: [
  ...
  lender: {
    ...
    accentHex: '#0D9488',
    allowedPaths: ['/', '/contracts', '/analytics', '/ipp', '/settlement', '/reports', '/notifications', '/settings', '/invoices', '/lender', '/vault', '/reporting-engine', '/support', '/pipeline', '/network', '/calendar'],
    kpis: [
  ...
  grid: {
    ...
    accentHex: '#EA580C',
    allowedPaths: ['/', '/metering', '/metering-analytics', '/analytics', '/contracts', '/compliance', '/reports', '/notifications', '/settings', '/vault', '/reporting-engine', '/support', '/grid-dashboard', '/scheduling', '/vpp', '/network', '/calendar'],
    kpis: [
  ...
  carbon_fund: {
    ...
    accentHex: '#10B981',
    allowedPaths: ['/', '/trading', '/carbon', '/carbon-deep', '/contracts', '/analytics', '/markets', '/portfolio', '/metering-analytics', '/risk', '/settlement', '/reports', '/notifications', '/settings', '/vault', '/trade-journal', '/reporting-engine', '/support', '/fund-dashboard', '/esg', '/deal-room', '/pipeline', '/calendar'],
    kpis: [
