...
const faqs = [
  { q: 'What is Ionvex Energy Exchange?', a: 'Ionvex is South Africa\'s first open-market energy trading platform, enabling generators, traders, offtakers, and IPP developers to trade energy, manage carbon credits, and close IPP deals digitally.' },
  ...
  { q: 'How secure is the platform?', a: 'Ionvex uses Cloudflare\'s global edge network with end-to-end encryption, JWT authentication, SHA-256 document hashing, and POPIA-compliant data handling.' },
      ...
      <nav className={`sticky top-0 z-50 backdrop-blur-xl ${isDark ? 'bg-[#0a1628]/90 border-b border-white/[0.06]' : 'bg-white/90 border-b border-slate-200'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-lg font-bold bg-gradient-to-r from-emerald-400 to-cyan-500 bg-clip-text text-transparent">Ionvex</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                                ...
                                <span className="font-bold">Ionvex</span>
              </div>
